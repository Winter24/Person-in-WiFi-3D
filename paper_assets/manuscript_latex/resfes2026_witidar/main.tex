...
Table~\ref{tab:flow} separates the draft-only model, disabled-flow inference, one-step flow, two-step flow, and retrained flow-loss variants. Two-step Euler inference on the original M9 checkpoint provides the best empirical balance among the tested solvers.
...
\begin{figure}[H]
    ...
    \caption{Flow solver analysis showing MPJPE and unmatched-person count.}
