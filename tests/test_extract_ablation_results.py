...
class TestExtractAblationResults(unittest.TestCase):
    def setUp(self):
        self.work_dir = ROOT / 'tests' / f'tmp_extract_ablation_{uuid.uuid4().hex}'
    ...
    def test_main_writes_last_val_row_per_run(self):
        ...
        expected_lines = [
            'M0_bone:{"mode": "val", "epoch": 5, "iter": 7824, "mpjpe": 243.16991}',
            'M1:{"mode": "val", "epoch": 5, "iter": 7824, "mpjpe": 242.66737}',
            'M2:{"mode": "val", "epoch": 5, "iter": 7824, "mpjpe": 265.33777}',
        ]
